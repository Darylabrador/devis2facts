...
export default {
    ...
    methods: {
        ...
        emis(value) {
            ...
            console.log('id:'+this.devis.id+', client_id: '+this.devis.client.id+', tva:'+this.devis.tva+', tht:'+this.devis.tht+', ttc:'+this.devis.ttc+', montantTva:'+this.devis.montantTva+', remise:'+this.devis.remise+ ', is_accepted:'+this.devis.is_accepted+', date_expiration:'+this.devis.expiration)
